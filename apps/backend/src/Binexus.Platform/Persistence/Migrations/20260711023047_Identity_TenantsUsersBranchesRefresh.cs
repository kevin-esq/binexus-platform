...
{
    /// <inheritdoc />
    public partial class Identity_TenantsUsersBranchesRefresh : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_users_role", "role IN ('SUPER_ADMIN','ADMIN','CASHIER','WAREHOUSE','DRIVER')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "ix_branches_tenant_id_name",
                table: "branches",
                columns: new[] { "tenant_id", "name" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "ix_refresh_tokens_family_id_revoked_at_utc",
