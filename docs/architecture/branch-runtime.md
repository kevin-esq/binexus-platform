...
Related decisions: [ADR-0016](../adr/0016-three-installation-modes.md) through [ADR-0032](../adr/0032-web-admin-synced-freshness.md). Operational security model (design freeze): [branch-operational-security.md](./branch-operational-security.md). Checkpoint: [branch-runtime-architecture-checkpoint.md](../migration/branch-runtime-architecture-checkpoint.md). Roadmap: [branch-runtime-roadmap.md](./branch-runtime-roadmap.md).
