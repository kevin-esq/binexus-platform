...
**CI:** `dotnet package list --file apps/backend/Binexus.slnx --vulnerable --include-transitive` (sin suprimir globalmente `NuGetAudit`)
...
Solo en `apps/backend/Directory.Build.props` (proyecto `Binexus.Api` es el único que referencia directa):
